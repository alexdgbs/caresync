    ...
    <article className="profile-card profile-card--editorial">
      ...
      <div className="profile-body">
        <section className="credentials">
          ...
          <dl className="professional-details">
            <div>
            ...
            <div>
              <dt>Especialidad</dt>
              <dd>{doctor.especialidad}</dd>
            </div>
            <div>
              <dt>Consultorio</dt>
              <dd>{doctor.ubicacion || "Ubicación por confirmar"}</dd>
            </div>
            <div>
              <dt>Contacto</dt>
              <dd>{doctor.telefono || "Mediante CareSync"}</dd>
            </div>
            <div>
              <dt>Idiomas</dt>
              <dd>
