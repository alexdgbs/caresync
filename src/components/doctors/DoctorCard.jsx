    ...
    >
      <div className="doctor-card__identity">
        ...
        <div className="doctor-card__actions">
          <button
            className={`quiet-action ${isSaved ? "is-saved" : ""}`}
            type="button"
            onClick={toggleSaved}
          ...
          >
            <FaHeart />
            <span>{isSaved ? "Favorito" : "Guardar"}</span>
          </button>
          <button
        ...
        {favoritePrompt && (
          <small className="favorite-login-prompt" role="status">
            <a href="/cuenta">Inicia sesión</a> para guardar favoritos.
          </small>
        )}
      </div>
